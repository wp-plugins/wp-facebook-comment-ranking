<div>
	...
	<form action="" method="POST">
		<table class="form-table">
			<tr>
				<th><label for="wp_fb_comment_ranking_frequency">更新頻度</label></th>
				<td>
					<select id="wp_fb_comment_ranking_frequency" name="wp_fb_comment_ranking_frequency">
			...
			<tr>
				<th><label for="wp_fb_comment_ranking_updatePostNumber">更新時にチェックする記事数</label></th>
				<td>
					<select id="wp_fb_comment_ranking_updatePostNumber" name="wp_fb_comment_ranking_updatePostNumber">
